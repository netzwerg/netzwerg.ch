...
Elm.Main.make = function (_elm) {
   ...
   $Set = Elm.Set.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var logoCss = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                      ,_0: "width"
                                                      ,_1: "50%"}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "position"
   ...
   _L.fromArray([$Html$Attributes.src("fhnw.png")
                ,logoCss]),
   _L.fromArray([]));
   var backgroundCss = function (isAnyKeyDown) {
      return function () {
         var background = isAnyKeyDown ? "#ffff00" : "#cccccc";
   ...
   var view = function (isAnyKeyDown) {
      return A2($Html.div,
      _L.fromArray([backgroundCss(isAnyKeyDown)]),
      _L.fromArray([logo]));
   };
   var isAnyKeyDown = A2($Signal.map,
   function (keys) {
